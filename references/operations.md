...
| Inspect VASP calculation | `./scripts/vasp-agent.ps1 vasp-inspect -RemotePath /public/home/user/x` | Structured inputs, structure, progress, completion, and errors |
| Validate VASP inputs | `./scripts/vasp-agent.ps1 vasp-validate -RemotePath /public/home/user/x` | Checks required inputs and basic consistency |
| VASP progress | `./scripts/vasp-agent.ps1 vasp-progress -RemotePath /public/home/user/x` | Compact convergence/progress summary |
| Read file | `./scripts/vasp-agent.ps1 read -RemotePath /public/home/user/x/OUTCAR` | Prints a text file, capped at 2 MiB |
| Tail file | `./scripts/vasp-agent.ps1 tail -RemotePath /public/home/user/x/OUTCAR -Lines 80` | Prints final lines |
| List directory | `./scripts/vasp-agent.ps1 list -RemotePath /public/home/user/x` | Runs `ls -la` on the remote directory |
| Create directory | `./scripts/vasp-agent.ps1 mkdir -RemotePath /public/home/user/x/new` | Runs `mkdir -p` on the remote directory |
| Copy | `./scripts/vasp-agent.ps1 copy -RemotePath /public/home/user/x -DestinationPath /public/home/user/y` | Recursively copies a remote path |
| Move | `./scripts/vasp-agent.ps1 move -RemotePath /public/home/user/x -DestinationPath /public/home/user/y` | Moves or renames a remote path |
| Remove | `./scripts/vasp-agent.ps1 remove -RemotePath /public/home/user/x` | Permanently deletes a remote file or directory |
| Submit | `./scripts/vasp-agent.ps1 submit -RemotePath /public/home/user/x -JobScript job.slurm` | Runs `sbatch` |
...
| Upload | `./scripts/vasp-agent.ps1 upload -LocalPath ./INCAR -RemotePath /public/home/user/x/INCAR` | Copies through Vlab |
| Download | `./scripts/vasp-agent.ps1 download -RemotePath /public/home/user/x/OUTCAR -LocalPath ./OUTCAR` | Copies through Vlab |
