...
STATE = module.STATE
STATE.servers = [
    {"name": "cl9", "root": "/public/home/user", "target": "user@cl9", "connected": True},
    {"name": "cl10", "root": "/public/home/user", "target": "user@cl10", "connected": True},
]
...
resp = post("/api/action/transfer", {
    "from_server": "cl9", "from_path": "/public/home/user/calc/x",
    "to_server": "cl10", "to_path": "/public/home/user/calc/x",
})
...
resp = post("/api/action/transfer", {
    "from_server": "cl9", "from_path": "/public/home/user/calc/y",
    "to_server": "cl10", "to_path": "/public/home/user/calc/y",
})
action_id = resp["action_id"]
...
assert args[2:4] == ("-FromPath", "/public/home/user/calc/y"), args
