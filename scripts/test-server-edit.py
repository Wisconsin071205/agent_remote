...
BASE = {
    ...
    "cl10": {"target": "wuhong@10.0.0.10", "port": 22, "remote_root": "/public/home/wuhong", "persist": "8h"},
}
...
assert run(name="cl10", target=None, port=None, remote_root="/public/home/wuhong/new", persist=None) == 0
assert written[-1]["servers"]["cl10"]["remote_root"] == "/public/home/wuhong/new", written[-1]
...
assert written[-1]["servers"]["cl9"]["target"] == "wuhong@114.214.201.44", "other fields untouched"
...
assert cfg["servers"]["cl9b"]["target"] == "wuhong@114.214.201.44", "entry carried over"
