...
module.CFG = {"servers": {
    "s0": {"target": "wuhong@alpha", "port": 22, "remote_root": "/pub/home/wuhong", "persist": "8h"},
    "s1": {"target": "wuhong@beta", "port": 22, "remote_root": "", "persist": "8h"},
}, "default_server": "s0"}
...
entry_home = {"target": "wuhong@beta", "port": 22, "remote_root": "", "persist": "8h"}

# Happy path: pull from s0 (fixed root), push to s1 (home boundary).
args = argparse.Namespace(from_server="s0", from_path="/pub/home/wuhong/calc/a",
                          to_server="s1", to_path="/pub/home/wuhong/calc/b")
...
assert pull[0] == ["scp", "-q", "-P", "22", "-o", "BatchMode=yes", "-o", "StrictHostKeyChecking=yes",
                   "-o", "ControlPath=s0.sock", "-r", "wuhong@alpha:/pub/home/wuhong/calc/a",
                   pull[0][-1]], pull[0]
assert push[0] == ["scp", "-q", "-P", "22", "-o", "BatchMode=yes", "-o", "StrictHostKeyChecking=yes",
                   "-o", "ControlPath=s1.sock", "-r", push[0][-2], "wuhong@beta:/pub/home/wuhong/calc/b"], push[0]
...
try:
    module.do_transfer(argparse.Namespace(from_server="s0", from_path="/pub/home/wuhong/x", to_server="s1", to_path="/pub/home/wuhong/y"))
