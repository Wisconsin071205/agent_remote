...
module.CFG = {"servers": {"s0": {"target": "wuhong@host", "port": 22, "remote_root": "", "persist": "8h"}},
              "default_server": "s0"}
...
entry_home = {"target": "wuhong@host", "port": 22, "remote_root": "", "persist": "8h"}
entry_fixed = {"target": "wuhong@host", "port": 22, "remote_root": "/public/home/wuhong/calc", "persist": "8h"}
...
assert module.validated_remote_path("/public/home/wuhong/calc/a", entry_fixed, "s2") == "/public/home/wuhong/calc/a"
try:
...
assert module.validated_remote_path("/public/home/wuhong/calc/b", entry_home, "s1") == "/public/home/wuhong/calc/b"
assert module.validated_remote_path("/public/home/wuhong", entry_home, "s1") == "/public/home/wuhong"
...
try:
    module.validated_remote_path("/public/home/wuhong/x", {"remote_root": ""}, "s3")
...
args = argparse.Namespace(name="s9", target="wuhong@host", port=22, remote_root=None, persist="8h")
...
module.CFG = {"servers": {"s9": {"target": "wuhong@host", "port": 22, "remote_root": "/a/b", "persist": "8h"}},
              "default_server": "s9"}
...
for bad in ("/bad root", "relative/path", "/a/../b"):
    entry = {"target": "wuhong@host", "port": 22, "remote_root": bad, "persist": "8h"}
    try:
