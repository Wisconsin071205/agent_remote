...
STATE = module.STATE
STATE.servers = [
    {"name": "cl9", "root": "/pub/home/user", "target": "user@cl9", "connected": True},
    {"name": "cl10", "root": "/pub/home/user", "target": "user@cl10", "connected": False},
    {"name": "cl12", "root": "/pub/home/user", "target": "user@cl12", "connected": True},
]
...
action_id, summary = module.stage_transfer("cl9", "/pub/home/user/calc/x", "cl12", "/pub/home/user/calc/x")
...
result = module.execute_tool(object(), "transfer_remote_files", {
    "from_server": "cl9", "from_path": "/pub/home/user/calc/y",
    "to_server": "cl12", "to_path": "/pub/home/user/calc/y",
})
...
assert args[0:2] == ("-FromServer", "cl9") and args[2:4] == ("-FromPath", "/pub/home/user/calc/y"), args

# Polling consumes the action; a second poll reports it expired.
resp = module.stage_transfer("cl9", "/pub/home/user/calc/z", "cl12", "/pub/home/user/calc/z", status="running")
